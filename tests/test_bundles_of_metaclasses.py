...
class TestBundlesOfMetaclasses():
    ...
    def testBundleDefinedMetaclasses(self):
        ...
        eq_(set(b1.get_elements(type=CMetaclass)), set([m1, m2, m3]))
        b2 = CBundle("B2")
        b2.elements = [m2, m3]
        eq_(set(b2.get_elements(type=CMetaclass)), set([m2, m3]))
    ...
    def testGetMetaclassesByName(self):
        ...
        eq_(set(self.b1.get_elements(type=CMetaclass, name ="M1")), set([m1]))
        m2 = CMetaclass("M1", bundles = self.b1)
        eq_(set(self.b1.get_elements(type=CMetaclass, name ="M1")), set([m1, m2]))
        ok_(m1 != m2)
        m3 = CMetaclass("M1", bundles = self.b1)
        eq_(set(self.b1.get_elements(type=CMetaclass, name ="M1")), set([m1, m2, m3]))
    ...
    def testGetMetaclassElementsByName(self):
        ...
        m1 = CMetaclass("M1", bundles = self.b1)
        eq_(set(self.b1.get_elements(name ="M1")), set([m1]))
        c1 = CClass(m1, "M1", bundles = self.b1)
        eq_(set(self.b1.get_elements(name ="M1")), set([m1, c1]))
        m2 = CMetaclass("M1", bundles = self.b1)
        eq_(set(self.b1.get_elements(name ="M1")), set([m1, c1, m2]))
        ok_(m1 != m2)
        m3 = CMetaclass("M1", bundles = self.b1)
        eq_(set(self.b1.get_elements(name ="M1")), set([m1, c1, m2, m3]))
    ...
    def testMetaclassDefinedBundleChange(self):
        ...
        eq_(set(self.b1.get_elements(type=CMetaclass)), set([m1]))
        eq_(set(b.elements), set([m2, cl2]))
        eq_(set(b.get_elements(type=CMetaclass)), set([m2]))
    ...
    def testCreationOfUnnamedMetaclassInBundle(self):
        ...
        eq_(set(self.b1.get_elements(type = CMetaclass, name = None)), set([m1, m2]))
        eq_(set(self.b1.get_elements(name = None)), set([m1, m2, cl]))
    ...
    def testRemoveMetaclassFromBundle(self):
        ...
        eq_(set(b1.get_elements(type=CMetaclass)), set([m2, m3]))
        b1.remove(m3)
        eq_(set(b1.get_elements(type=CMetaclass)), set([m2]))
    ...
    def testRemoveBundleFromTwoBundles(self):
        ...
        b1.remove(m1)
        eq_(set(b1.get_elements(type=CMetaclass)), set())
        eq_(set(b2.get_elements(type=CMetaclass)), set([m1]))
    ...
    def testDeleteMetaclassHavingTwoBundles(self):
        ...
        m1.delete()
        eq_(set(b1.get_elements(type=CMetaclass)), set())
        eq_(set(b2.get_elements(type=CMetaclass)), set([m2]))
