...
class TestBundlesOfClasses():
    ...
    def testClassDefinedBundles(self):
        ...
        eq_(set(self.b1.get_elements()), set([cl1]))
        ...
        eq_(set(self.b1.get_elements(type = CClass)), set([cl1, cl2, cl3]))
        eq_(set(self.b1.elements), set([cl1, cl2, cl3, mcl]))     
        eq_(set(self.b2.get_elements(type = CClass)), set([cl3]))
    ...
    def testBundleDefinedClasses(self):
        ...
        eq_(set(b1.get_elements(type = CClass)), set([cl1, cl2, cl3]))
        b2 = CBundle("B2")
        b2.elements = [cl2, cl3]
        eq_(set(b2.get_elements(type = CClass)), set([cl2, cl3]))
    ...
    def testGetClassesByName(self):
        ...
        eq_(set(self.b1.get_elements(type=CClass, name ="CL1")), set([c1]))
        c2 = CClass(self.mcl, "CL1", bundles = self.b1)
        eq_(set(self.b1.get_elements(type=CClass, name ="CL1")), set([c1, c2]))
        ok_(c1 != c2)
        c3 = CClass(self.mcl, "CL1", bundles = self.b1)
        eq_(set(self.b1.get_elements(type=CClass, name ="CL1")), set([c1, c2, c3]))
    ...
    def testGetClassElementsByName(self):
        ...
        c1 = CClass(self.mcl, "CL1", bundles = self.b1)
        eq_(set(self.b1.get_elements(name ="CL1")), set([c1]))
        m = CMetaclass("CL1", bundles = self.b1)
        eq_(set(self.b1.get_elements(name ="CL1")), set([m, c1]))
        c2 = CClass(self.mcl, "CL1", bundles = self.b1)
        eq_(set(self.b1.get_elements(name ="CL1")), set([m, c1, c2]))
        ok_(c1 != c2)
        c3 = CClass(self.mcl, "CL1", bundles = self.b1)
        eq_(set(self.b1.get_elements(name ="CL1")), set([m, c1, c2, c3]))
    ...
    def testClassDefinedBundleChange(self):
        ...
        eq_(set(self.b1.get_elements(type = CClass)), set([cl1]))
        eq_(set(b.elements), set([cl2, self.mcl]))
        eq_(set(b.get_elements(type = CClass)), set([cl2]))
    ...
    def testCreationOfUnnamedClassInBundle(self):
        ...
        eq_(set(self.b1.get_elements(type=CClass)), set([c1, c2, c3]))
        eq_(self.b1.get_element(type=CClass, name = None), c1)
        eq_(set(self.b1.get_elements(type=CClass, name = None)), set([c1, c2]))
        eq_(set(self.b1.get_elements(name = None)), set([c1, c2, mcl]))
    ...
    def testRemoveClassFromBundle(self):
        ...
        eq_(set(b1.get_elements(type=CClass)), set([cl2, cl3]))
        b1.remove(cl3)
        eq_(set(b1.get_elements(type=CClass)), set([cl2]))
    ...
    def testRemoveBundleFromTwoBundles(self):
        ...
        b1.remove(c1)
        eq_(set(b1.get_elements(type=CClass)), set())
        eq_(set(b2.get_elements(type=CClass)), set([c1]))
    ...
    def testDeleteClassHavingTwoBundles(self):
        ...
        c1.delete()
        eq_(set(b1.get_elements(type=CClass)), set())
        eq_(set(b2.get_elements(type=CClass)), set([c2]))
