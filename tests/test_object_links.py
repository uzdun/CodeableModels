...
class TestObjectLinks():
    ...
    def testNToNSetSelfLink(self):
        self.c1.association(self.c1, name = "a", source_multiplicity = "*", multiplicity = "*", source_role_name = "super", role_name = "sub")
    ...
    def testLinkWithInheritanceInClassifierTargets_Usingrole_names(self):
        ...
        o_super_1 = CObject(self.c2, "o_super_1")
        o_super_2 = CObject(self.c2, "o_super_2")
        set_links({o1: [o_sub_1, o_sub_2]}, role_name = "subCl")
        ...
        eq_(o2.get_links(association = a1), [])
        eq_(o2.get_links(association = a2), [o_super_1, o_super_2])
        eq_(o1.get_links(role_name = "subCl"), [o_sub_1, o_sub_2])
        eq_(o1.get_links(role_name = "c2"), [o_sub_1])
        eq_(o2.get_links(role_name = "subCl"), [])
    ...
    def testGetLinkObjects(self):
        ...
        link_objects2 = set_links({o1: o2Sub})
        ...
        link_objects5 = set_links({o1: o1Sub}, role_name = "next")
        ...
        set_links({o1Sub: o1}, role_name = "next")
        eq_(len(o1Sub.link_objects), 1)
        link1 = o1Sub.link_objects[0]
        link2 = [o for o in o1Sub.link_objects if o.association == a2][0]
        eq_(link1, link2)
        eq_(link1.association, a2)
