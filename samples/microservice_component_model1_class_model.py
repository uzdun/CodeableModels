"""
*File Name:* samples/microservice_component_model1.py
...
microservice_component_model1 = CBundle("microservice_component_model1",
                                        elements=api_gateway.class_object.get_connected_elements())


def run():
    print("***************** Microservice Component Model 1: Meta-modelling example *****************")
    print('*** Plant UML Generation')
    generator = PlantUMLGenerator()
    generator.object_model_renderer.left_to_right = True
    generator.generate_object_models(microservice_component_model1.name, [microservice_component_model1, {}])
    print(f"... Generated models in {generator.directory!s}/{microservice_component_model1.name!s}")
